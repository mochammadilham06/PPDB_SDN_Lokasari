 ...
 */
public class KepalaSekolah extends javax.swing.JFrame {

    /**
     * Creates new form KepalaSekolah
     */
    ...
    private void initComponents() {
        ...
        label8.setText("Daftar Siswa Lolos");
        ...
        jPanel13.add(kelolaJenis, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 320, 60));
        ...
        jLabel2.setText("Hallo, Asep Saepudin M.Pd");
        navbar.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 0, -1, 50));
    ...
    private void kelolaJenisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kelolaJenisMouseClicked
        DaftarSiswaLolosKS frmMasterSatuan = new DaftarSiswaLolosKS();
   ...
   setIconImage(icon.getImage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KepalaSekolah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KepalaSekolah().setVisible(true);
            }
        });
    }
