 ...
 * @author lanz1
 */
public class DashboardKS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelLogout.setBackground(new java.awt.Color(153, 153, 153));
        ...
        jPanel13.add(jPanelLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 570, 230, -1));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ImageIcon icon = new ImageIcon(getClass().getResource("images/250.png"));
   setIconImage(icon.getImage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardKS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardKS().setVisible(true);
            }
        });
    }
