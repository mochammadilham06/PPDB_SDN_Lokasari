 ...
 * @author lanz1
 */
public class DaftarSiswaLolosKS extends javax.swing.JInternalFrame {

    /**
     * Creates new form MasterBarang
     */
    public DaftarSiswaLolosKS() {
        initComponents();
    ...
    public ArrayList<siswaLolos> getSiswaList()
    {
       ArrayList<siswaLolos> siswaList = new ArrayList<siswaLolos>();
       
       String query = "SELECT * FROM siswa INNER JOIN user ON siswa.user_id=user.id WHERE siswa.status=\"Lulus\"";
       ...
       try{
           ...
           while(rs.next()){
               ...
               Siswa = new siswaLolos(rs.getInt("nomor_peserta"), rs.getInt("tahun_ajaran"),rs.getString("nama"), rs.getString("jenis_kelamin"), rs.getDate("tanggal_lahir"), rs.getString("no_nik"), rs.getString("alamat"), rs.getString("status"), rs.getString("nama_lengkap"));
               siswaList.add(Siswa);
           }        
       }catch(Exception e){
           e.printStackTrace();
    ...
    public void show_Siswa_inJTable(){
        ...
        ArrayList<siswaLolos> list = getSiswaList();
        ...
        for(int i=0; i < list.size(); i++){
            ...
            row[6] = list.get(i).getNoNik();
            row[7] = list.get(i).getAlamat();
            row[8] = list.get(i).getStatus();
            row[9] = list.get(i).getNamaPetugas();
            model.addRow(row);
        }       
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Nomor Peserta", "Tahun Ajaran", "Nama Peserta", "Jenis Kelamin", "Tanggal Lahir", "No NIK", "Alamat", "Status", "Petugas"
            }
        ) {
        ...
        jLabel7.setText("Dashboard/ Daftar Siswa Lolos Seleksi");
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
//            String namaFile = "src/reports/daftar-peserta-lolos.jasper";
            HashMap hash = new HashMap();
//            File file = new File(namaFile);
//                        JasperReport jasperReport = (JasperReport) JRLoader.loadObject(file.getPath());
//                        JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hash, con);
//                        JasperViewer.viewReport(jasperPrint, false);
    InputStream file = getClass().getResourceAsStream("/reports/validasi-ks.jrxml");
